...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Google Tag Manager – carga segura en Next */}
        <Script id="gtm" strategy="afterInteractive">
          {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
          new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
          j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
          'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
          })(window,document,'script','dataLayer','GTM-T88Z3KS7');`}
        </Script>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=24742952045389128&ev=PageView&noscript=1"
          />
        </noscript>
          ...
          />
          <noscript>
            <img src='//create.leadid.com/noscript.gif?lac=1A0362DA-90B6-2BCA-983C-BC60069F93FC&lck=e65966e8-6ae1-2bff-6dd1-97b99a2c15cf&snippet_version=2' />
          </noscript>
      ...
      <body className={inter.className}>
        ...
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T88Z3KS7"
        ...
        {/* Botón flotante móvil para redirigir al formulario */}
